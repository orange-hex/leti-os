...
g++ -static -o task9s.out $BUILD_DIR/task9s.o -L $BUILD_DIR $BUILD_DIR/libs.a
...
g++ -o task9d.out $BUILD_DIR/task9d.o -L $BUILD_DIR $BUILD_DIR/libd.so

echo "Compiled executable with dynamic library (./task9d)"

g++ -c -o $BUILD_DIR/task9dr.o task9dr.cpp
g++ -o task9dr.out $BUILD_DIR/task9dr.o -L $BUILD_DIR $BUILD_DIR/libd.so
